'''
ok nigger so in this file you can clearly see the i have 'number' defined perfectly fucking fine
...
*** *** *** ***
# main() is used for unit testing only. It will run when
stock_class.py is run.
# Run this to test your class code. Once you have eliminated all
errors, you are
